...
class DeepForestModel(RegressionModel):
    def __init__(self, name: str = "DeepForest", task_name: str = '', seed: int = 2024, model_dir = None, results_dir = None, n_dim=None) -> None:
        super().__init__(name)
    ...
    def _optimize_hyperparameters_optuna(self, 
        ...
        def object_func(trial):
            ...
            model = CascadeForestRegressor(random_state=self.random_state,
                                            n_jobs=-1,
                                          **trial_args_dict)
