...
class CatBoostModel(RegressionModel):
    def __init__(self, name: str = "CatBoost", task_name: str = '', seed: int = 2024, model_dir = None, results_dir = None, n_dim=None) -> None:
        super().__init__(name)
        ...
        if task_name == 'MurA':
            ...
            self.max_depth = 7
            self.n_estimators = 251 
            self.learning_rate = 0.07550283848208214
        else:
            self.max_depth = 5
            self.n_estimators = 294
            self.learning_rate = 0.09152523997275597
    ...
    def fit(self, 
        ...
        if optimize_hyperparams:
            ...
            self.model = CatBoostRegressor(random_state=self.random_state,
                                            task_type=self.task_type,
                                            devices=self.devices,
                                               **best_params)
    ...
    def _optimize_hyperparameters_optuna(self, 
        ...
        def object_func(trial):
            ...
            model = CatBoostRegressor(random_state=self.random_state,
                                    task_type=self.task_type,
                                    devices=self.devices,
                                          **trial_args_dict)
